...
docker run --rm -e WINEDEBUG=-all -v $PWD/../01-raw_data:/data -v $PWD:/output chambm/pwiz-skyline-i-agree-to-the-vendor-licenses wine msconvert /data/*.D -o /output/ --filter "peakPicking true 1-"
